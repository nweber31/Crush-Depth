...
# 1 "start.h" 1
# 22 "start.h"
extern const unsigned short startTiles[3744];
...
# 23 "main.c" 2
# 1 "waterBackground.h" 1
# 22 "waterBackground.h"
...
extern const unsigned int waterMusic_sampleRate;
extern const unsigned int waterMusic_length;
extern const signed char waterMusic_data[];
# 26 "main.c" 2
...
void initialize() {
    ...
    DMANow(3, subSpritesPal, ((u16 *)0x5000200), 512 / 2);
...
void goToStart() {
    ...
    DMANow(3, startTiles, &((charblock *)0x06000000)[0], 7488 / 2);
...
void goToInstructions() {
    ...
    DMANow(3, instructionsTiles, &((charblock *)0x06000000)[0], 5024 / 2);
...
void goToGame() {
    ...
    (*(volatile unsigned short*)0x400000A) = ((2) << 2) | ((24) << 8) | (0 << 7) | (0 << 14);
    state = GAME;
    DMANow(3, reefPal, ((unsigned short *)0x5000000), 512 / 2);
    DMANow(3, reefTiles, &((charblock *)0x06000000)[0], 45728 / 2);
    DMANow(3, reefMap, &((screenblock *)0x6000000)[28], 8192 / 2);

    DMANow(3, waterBackgroundTiles, &((charblock *)0x06000000)[2], 10304 / 2);
    DMANow(3, waterBackgroundMap, &((screenblock *)0x6000000)[24], 2048 / 2);
}
...
void goToPause() {
    ...
    (*(volatile unsigned short*)0x400000C) = ((1) << 2) | ((20) << 8) | (0 << 7) | (0 << 14);

    state = PAUSE;

    pauseSound();
    DMANow(3, pausePal, ((unsigned short *)0x5000000), 512 / 2);
    DMANow(3, pauseTiles, &((charblock *)0x06000000)[1], 4800 / 2);
...
void goToWin() {
    ...
    DMANow(3, winTiles, &((charblock *)0x06000000)[1], 9728 / 2);
...
void goToLose() {
    ...
    DMANow(3, loseTiles, &((charblock *)0x06000000)[1], 13472 / 2);
